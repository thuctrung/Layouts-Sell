								...
								<div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header">
											<a href="product.html"><img src="/source/image/product/{{$new->image}}" alt="" width= "300px"  height="250px"></a>
										</div>
						...
						<div class="beta-products-list">
							...
							@foreach($products as $s)
								<div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header">
											<a href="product.html"><img src="/source/image/product/{{$s->image}}" alt="" width= "300px"  height="250px></a>
										</div>
										<div class="single-item-body">
